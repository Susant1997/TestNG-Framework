...
public class BaseClass {
		...
		public static void takesScreenShot() throws IOException {
			...
			File d = new File("C:\\Users\\susan\\OneDrive\\Pictures\\Saved Pictures\\book3.jpg");
	...
	public static String excelRead (int rowNo, int cellNo) throws IOException  {
		...
		File f = new File("C:\\Users\\susan\\eclipse-workspace\\TestNGProject\\data\\Addact.xlsx");
